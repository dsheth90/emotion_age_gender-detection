...
from app.model_age import predict_age
import numpy as np
from app.model_gender import predict_gender
import matplotlib.pyplot as plt

facec = cv2.CascadeClassifier('app/models/haarcascade_frontalface_default.xml')
